...
public class Education extends Fragment implements PostRecyclerViewAdapter.OnpostClickListner{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(Objects.equals(user_state, "normal_user")){
            ...
            Objects.requireNonNull(Objects.requireNonNull(homeActivity).getSupportActionBar()).setTitle(getString(R.string.education));
        }
        else if(Objects.equals(user_state, "admin")){
            AdminHomeActivity adminHomeActivity = (AdminHomeActivity) getActivity();
            Objects.requireNonNull(Objects.requireNonNull(adminHomeActivity).getSupportActionBar()).setTitle(getString(R.string.education));
        }
        ...
        postsViewModel.get_posts_by_type(getString(R.string.education)).observe(getViewLifecycleOwner(), postsEntities -> adapter.setList(postsEntities));
        return root;
    }
