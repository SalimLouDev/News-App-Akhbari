...
public class Health extends Fragment implements PostRecyclerViewAdapter.OnpostClickListner {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        postsViewModel.get_posts_by_type(getString(R.string.health)).observe(getViewLifecycleOwner(), adapter::setList);
        return root;
    }
